...
func main() {
	...
	glog.Infof("az-keyvault-reader side car admission control hook is starting...")
	...
	glog.Infof("az-keyvault-reader side car admission control listening on port 8443")
